...
struct FitnessSummaryView: View {
  ...
  private var averageHeartRateText: String {
    guard let heartRate = session.averageHeartRate ?? healthKit.latestHeartRateBPM else {
      return "--BPM"
    }
  ...
  private var peakHeartRateText: String {
    guard let heartRate = session.maxHeartRate ?? healthKit.latestHeartRateBPM else {
      return "--BPM"
    }
    return "\(heartRate)BPM"
  }
