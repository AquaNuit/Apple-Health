...
struct SleepV2BandSyncCard: View {
    ...
    VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 0) {
        SleepV2BandSyncRow(
          palette: palette,
          title: "Status",
          value: "Automatic via Apple Health",
      ...
      HStack(spacing: 10) {
        Button(action: onSync) {
          Label("Sync via Health", systemImage: "arrow.down.circle.fill")
  ...
  private var syncSubtitle: String {
    "Apple Health syncs your historical sleep automatically in the background."
  }
}
